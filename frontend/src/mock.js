...
export const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Developed an extractive text summarization system for Hindi language using NLP techniques, TextRank, and BERT-based embeddings. Curated a dataset of 1,000 Hindi articles and deployed the solution using Google Colab and Hugging Face, contributing to the Hindi NLP ecosystem.",
